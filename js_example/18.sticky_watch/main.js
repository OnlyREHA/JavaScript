...
function setProperty(){
    ...
    scrollHeight = scrollBody.offsetHeight;  //fix_motion 높이값
    sectionOffsetTop = scrollBody.offsetTop;  ////fix_motion Top값
...
function imageChage(moveX){
    ...
    img.style.transform = `translate(${-moveX}px)`;
}
